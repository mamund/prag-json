...
+enctype+:: 
This property represents the media type to use when encoding a mesage body to be sent during a state transition. The default value for this field is +application/x-www-form-urlencoded+. However, any valid media type string (<<mediatype-iana, [MEDIATYPE-IANA]>>) MAY appear in the +enctype+ property.
 ...
 * [[json-schema]] [JSON-SCHEMA] "JSON Schema Specification", September 2019, https://json-schema.org/specification.html
  * [[methods-iana]] [METHODS-IANA] "Hypertext Transfer Protocol (HTTP) Method Registry", February 2014, https://www.iana.org/assignments/http-methods/http-methods.xhtml
  * [[mediatype-iana]] [MEDIATYPE-IANA] "Media Types", December 2019, https://www.iana.org/assignments/media-types/media-types.xhtml
